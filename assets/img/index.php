...
<head>
    ...
    <!-- app favicon -->
    <link rel="shortcut icon" href="<?= BASE_ICON ?>">
    <!-- google fonts -->
                                    ...
                                    <div class="dropdown-menu mega-menu animated fadeIn" aria-labelledby="navbarDropdown">
                                        <div class="row no-gutters">
                                            <div class="col-sm-2 p-20">
                                                ...
                                                <ul>                                                   
                                                    <li class="nav-link">
                                                        <a href="">Cadastro dos clientes</a>
                                                    </li>
													<li class="nav-link">
                                                        <a href="">Cadastro de funcion�rios</a>
                                                    </li>
													<li class="nav-link">
                                                        <a href="">Cadastro de servi�os</a>
                                                    </li>
													<li class="nav-link">
                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li>
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li> <a href=''>Cadastrar Funcion�rios</a> </li>
                                    <li> <a href=''>Cadastrar Servi�os</a> </li>
                            ...
                            <li>
                                <a class="has-arrow" href="javascript:void(0)" aria-expanded="false"><i class="nav-icon ti ti-bag"></i> <span class="nav-title">Relat�rios</span></a>
                              
                            </li>
                            <li>
                                <a class="has-arrow" href="javascript:void(0)" aria-expanded="false"><i class="nav-icon ti ti-info"></i><span class="nav-title">Configura��o do Sistema</span> </a>
            ...
            <footer class="footer">
                <div class="row">
                    <div class="col-12 col-sm-6 text-center text-sm-left">
                        <p> Copyright 2019. FEUDUC - FORMANDOS��.</p>
                    </div>                
                </div>
            </footer>
            <!-- end footer -->
